% this is a faster version of peptide_mid, ~3 times faster
% used binary array instead of categorical for tb.type
function [out,tb]=peptide_mid1(peptide,maxM,ext,type)
%##input 
